...
%         receiverDelaySample)];
    ...
    receivedPulse1 = [exp(1j*2*pi*(carrierFrequency+dopplerEffect).*(chirpTimeAxis-tau)).*...
    ...
    receivedPulseTau2 = exp(1j*2*pi*(carrierFrequency+dopplerEffect2).*(tauTimeAxis2-tau2)).*...
        exp(1j*pi*chirpSlope*(1+dopplerRatio2).*(tauTimeAxis2-tau2).^2);

    receivedPulse2 = [exp(1j*2*pi*(carrierFrequency+dopplerEffect2).*(chirpTimeAxis-tau2)).*...
        exp(1j*pi*chirpSlope*(1+dopplerRatio2).*(chirpTimeAxis-tau2).^2) ...
        zeros(1, round((pulseDuration-chirpDuration)*samplingRate))];
